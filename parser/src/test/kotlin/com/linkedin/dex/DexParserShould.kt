...
class DexParserShould {
    ...
    fun parseCorrectNumberOfTestMethods() {
        val testMethods = DexParser.findTestNames(APK_PATH, "all", listOf(""))
    ...
    fun parseMethodWithMultipleMethodAnnotations() {
        val testMethods = DexParser.findTestMethods(APK_PATH, "all", listOf("")).filter { it.annotations.filter { it.name.contains("TestValueAnnotation") }.isNotEmpty() }
    ...
    fun parseInheritedMethodAnnotation() {
        val testMethods = DexParser.findTestMethods(APK_PATH, "all", listOf("")).filter { it.annotations.filter { it.name.contains("InheritedAnnotation") }.isNotEmpty() }
    ...
    private fun getBasicJunit4TestMethod(): TestMethod {
        val testMethods = DexParser.findTestMethods(APK_PATH, "all", listOf("")).filter { it.annotations.filter { it.name.contains("TestValueAnnotation") }.isNotEmpty() }.filter { it.testName.equals("com.linkedin.parser.test.junit4.java.BasicJUnit4#basicJUnit4") }
    ...
    private fun getSecondBasicJunit4TestMethod(): TestMethod {
        val testMethods = DexParser.findTestMethods(APK_PATH, "all", listOf("")).filter { it.annotations.filter { it.name.contains("TestValueAnnotation") }.isNotEmpty() }.filter { it.testName.equals("com.linkedin.parser.test.junit4.java.BasicJUnit4#basicJUnit4Second") }
